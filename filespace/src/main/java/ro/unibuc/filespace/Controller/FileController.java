...
//    private final FileMetadataService fileMetadataService;
    ...
    public ResponseEntity<Void> uploadFile(@PathVariable long groupId, @RequestParam("file") MultipartFile file1) throws FileIsEmpty, IOException, UserNotInGroup, FileWithNameAlreadyExists {
